<?php
include_once('bom_material_element.inc');
...
//$query1= " CREATE TABLE material_element(
//  material_element_id int(12) NOT NULL AUTO_INCREMENT,
//	material_element VARCHAR(50) NOT NULL,
//  description VARCHAR(256) NOT NULL,
//  org_id int(12) NOT NULL,
//  status varchar(50),
//  multi_org_cb boolean,
//  default_material_element int(12),
//  ef_id int(12),
//  created_by varchar(256),
//  creation_date date,
//  last_update_by varchar(256),
//  last_update_date date,
//	PRIMARY KEY ( material_element_id )
//	)" ;
//
//
...
//$result = $db->query($query);
//
$query = "SHOW COLUMNS FROM bom_material_element ";
