...
$query1 = " CREATE TABLE bom_overhead_resource_assignment(
...
$query11 = " CREATE TABLE bom_overhead_rate_assignment(
...
//$result = $db->query($query);
//
$query = "SHOW COLUMNS FROM bom_overhead_resource_assignment ";
