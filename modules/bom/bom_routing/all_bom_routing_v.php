...
//	 print_r($search_result);
	 	 $search_result_statement = search::search_result('po', $column_array, $search_result, $primary_column, $view_path, 'Y', 'Update');
//		 $return_value['search_result'] = $search_result;
	}
if(!empty($pagination)){
$pagination_statement = $pagination->show_pagination($pagination, 'all_po_v', $pageno, $query_string );
}
?>
