<?php
include_once('bom_department.inc');
...
//}
//
//$query1 = " CREATE TABLE bom_department_resource_assignment(
...
//
$query11 = " CREATE TABLE bom_standard_operation(
  bom_standard_operation_id int(12) NOT NULL AUTO_INCREMENT,
	bom_standard_operation varchar(20) NOT NULL,
...
//$query2 = "ALTER TABLE bom_department_resource_assignment 
//  ADD `no_of_units` int(12),
//ADD `efficiency` int(12),
//ADD `utilization` int(12)";
...
//$result = $db->query($query);
//
$query = "SHOW COLUMNS FROM bom_standard_operation ";
