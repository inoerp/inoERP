				 ...
				 <div id="tabsHeader">
					<div class="large_shadow_box"><span class="heading"></span>
					 <ul class="column five_column">
						<li>
						 <label><img id="bom_standard_operation_popup" class="showPointer bom_standard_operation_popup" src="<?php echo HOME_URL; ?>themes/images/serach.png"/>
							Standard Operation Id : </label>
						 <?php echo form::text_field_d('bom_standard_operation_id'); ?>
						 ...
						 <tbody class="form_data_line_tbody bom_standard_operation_resource_assignment_values" >
							...
							foreach ($bom_standard_operation_resource_assignment_object as $bom_standard_operation_resource_assignment) {
							 ...
							 <td><?php form::number_field_wid2s('resource_sequence') ?></td>
 							 ...
 							 <td><?php form::number_field_wid2s('usage') ?></td>
							 <td><?php echo form::select_field_from_object('schedule', bom_header::bom_schedule_option(), 'option_line_id', 'option_line_code', $$class_second->schedule, 'schedule', $readonly, 'default_basis'); ?></td>
