<?php
include_once('bom_standard_operation.inc');
...
//}
//
//$query1 = " CREATE TABLE bom_standard_operation_resource_assignment(
//  bom_standard_operation_resource_assignment_id int(12) NOT NULL AUTO_INCREMENT,
//  bom_standard_operation_id int(12) NOT NULL,
...
// ";
//
$query4= "ALTER TABLE bom_routing_detail
DROP `effective_start_date`,
DROP `effective_end_date`,
DROP `eco_number`,
DROP `eco_implemented_cb`,
DROP `yield`,
DROP `ef_id`,
DROP `supply_locator` ";
//	
...
//$result2 = $db->query($query2);
//
$query = "SHOW COLUMNS FROM bom_routing_header ";
