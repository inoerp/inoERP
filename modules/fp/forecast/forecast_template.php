					 ...
					 <div class="large_shadow_box"> 
						<ul class="column four_column">
						 <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="forecast_header_id select_popup clickable">
							 Forecast Id : </label>
							<?php echo form::text_field('fp_forecast_header_id', $$class->fp_forecast_header_id, '15', '25', '', 'System Number', 'fp_forecast_header_id', $readonly) ?>
						 ...
						 <li><label>Forecast (2): </label>
							<?php form::text_field_dm('forecast'); ?>
						 </li>
						 ...
						 <li><label>Demand Class: </label>
							<?php $f->text_field_d('demand_class'); ?>
						 </li>
