<?php
include_once('wip_move_transaction.inc');
...
//$class = wip_move_transaction::find_all();
echo '<pre>';
...
//}
//
//$query1 = " CREATE TABLE wip_move_transaction_resource_assignment(
//  wip_move_transaction_resource_assignment_id int(12) NOT NULL AUTO_INCREMENT,
//  wip_move_transaction_id int(12) NOT NULL,
...
//	PRIMARY KEY ( wip_move_transaction_resource_assignment_id )
//	)";
//
//
//$result1 = $db->query($query1);
//$query11 = " CREATE TABLE wip_move_transaction_rate_assignment(
//  wip_move_transaction_rate_assignment_id int(12) NOT NULL AUTO_INCREMENT,
//  wip_move_transaction_id int(12) NOT NULL,
...
//  last_update_by varchar(256),
//  last_update_date date,
//	PRIMARY KEY ( wip_move_transaction_rate_assignment_id )
//	)";
//
//
//$result11 = $db->query($query11);
//$query2= "ALTER TABLE wip_move_transaction 
//CHANGE `item_number` item_number varchar(50)";
...
//$query2= "ALTER TABLE wip_move_transaction_routing_detail 
...
//$result2 = $db->query($query2);
//
//$query3= "ALTER TABLE wip_move_transaction_bom 
...
$query = "SHOW COLUMNS FROM wip_move_transaction ";
...
//echo "<h2>Routing Details</h2>";
//$query = "SHOW COLUMNS FROM wip_move_transaction_routing_detail ";
//$result = $db->query($query);
//
//while ($rows = $db->fetch_array($result)) {
// echo '<br /> field_name is ' . $rows['Field'];
