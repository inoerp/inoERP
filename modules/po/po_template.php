           ...
           <div class="large_shadow_box"> 
            <ul class="column five_column">
             ...
             <li><label>BU Name(1) : </label>
              <?php echo $f->select_field_from_object('bu_org_id', org::find_all_business(), 'org_id', 'org', $po_header->bu_org_id, 'bu_org_id', '', 1, $readonly1); ?>
             </li>
             <li><label>PO Type(2) : </label>
              <?php echo $f->select_field_from_object('po_type', po_header::po_types(), 'option_line_code', 'option_line_value', $po_header->po_type, 'po_type', '', 1, $readonly1); ?>
             </li>
          ...
          <div id="tabsHeader-2" class="tabContent">
           <div> 
            <ul class="column five_column">
             ...
             <li><label>Released Amount : </label> <?php form::number_field_d('released_amount'); ?> </li>
                       ...
                       <tbody class="form_data_detail_tbody">
                        ...
                        foreach ($po_detail_object as $po_detail) {
                         ...
                         <tr class="po_detail<?php echo $count . '-' . $detailCount; ?><?php echo $detailCount != 0 ? ' new_object' : '' ?>">
                          ...
                          <td><?php echo $f->number_field('shipment_number', $$class_third->shipment_number, '', 'detail_number', 'seq_number', 1); ?></td>
