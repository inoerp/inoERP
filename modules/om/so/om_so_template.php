	 ...
	 <div id="content">
		<div id="structure">
		 <div id="om_so_divId">
			...
			<div id ="form_header">
			 <form action=""  method="om_sost" id="om_so_header"  name="om_so_header">
				<div id="tabsHeader">
         <ul class="tabMain">
					 ...
					 <div class="large_shadow_box"> 
						<ul class="column four_column">
						 <li><label>BU Name(1) : </label>
							<?php echo form::select_field_from_object('bu_org_id', org::find_all_business(), 'org_id', 'org', $om_so_header->bu_org_id, 'bu_org_id', $readonly, '', ''); ?>
						 </li>
						 <li><label>PO Type(2) : </label>
							<?php echo form::select_field_from_object('om_so_type', om_so_header::om_so_types(), 'option_line_code', 'option_line_code', $om_so_header->om_so_type, 'om_so_type', $readonly, '', ''); ?>
						 </li>
						 <li><label>PO Header Id : </label>
							<?php echo form::text_field('om_so_header_id', $om_so_header->om_so_header_id, '15', '25', '', 'System Number', 'om_so_header_id', $readonly) ?>
							<a name="show" href="om_so.php?om_so_header_id=" class="show om_so_header_id">
							 <img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
						 </li>
						 <li><label>PO Number : </label>
							<?php echo form::text_field_d('om_so_number'); ?>
						 </li>
						 <li>
							<label>
							 <input type="button"  class="find_om_sopup supplierId">
<!--							 <img class="supplier_id_om_sopup" src="<?php echo HOME_URL; ?>themes/images/serach.png"/>-->
							 Supplier Id(3) : </label>
						 ...
						 <li><label>Status : </label>                      
							<span class="button"><?php echo!empty($$class->om_so_status) ? $$class->om_so_status : ""; ?></span>
						 </li>
					 ...
					 <div> 
						<ul class="column five_column">
						 <li><label>Currency : </label>
							<?php echo!(empty($om_so_currency_statement)) ? $om_so_currency_statement : form::text_field_d('currency'); ?>
						 </li>
						 <li><label>Payment Term : </label>
							<?php echo!(empty($om_so_paymentTerm_statement)) ? $om_so_paymentTerm_statement : form::text_field_d('payment_term_id'); ?>
						 </li>
					 ...
					 <div> 
						<ul class="column five_column">
						 <li><label>Ship To Site Id : 
							 <img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="address_om_sopup"></label>
					...
					<div id="tabsHeader-4" class="tabContent">
					 <div> 
						<div id="show_attachment" class="show_attachment">
						 ...
						 <?php echo file::attachment_statement($om_so_file); ?>
						...
						<ul class="column four_column">
						 <li id="document_print"><label>Document Print : </label>
							<a class="button" target="_blank"
								 href="om_so_print.php?om_so_header_id=<?php echo!(empty($$class->om_so_header_id)) ? $$class->om_so_header_id : ""; ?>" >Print PO</a>
						 </li>
						 <li id="document_status"><label>Change Status : </label>
							<?php echo form::select_field_from_object('om_so_status', om_so_header::om_so_status(), 'option_line_code', 'option_line_code', $om_so_header->om_so_status, 'set_om_so_status', $readonly, '', ''); ?>
						 </li>
			...
			<div id="form_line" class="form_line"><span class="heading">PO Lines & Shipments </span>
			 <form action=""  method="om_sost" id="om_so_site"  name="om_so_line">
				<div id="tabsLine">
				 <ul class="tabMain">
					...
					<div id="tabsLine-1" class="tabContent">
					 <table class="form_line_data_table">
						...
						<tbody class="form_data_line_tbody">
						 <?php
						 $count = 0;
						 foreach ($om_so_line_object as $om_so_line) {
							?>         
 						 <tr class="om_so_line<?php echo $count ?>">
 							<td>    
 							 <ul class="inline_action">
 								<li class="add_row_img"><img  src="<?php echo HOME_URL; ?>themes/images/add.png"  alt="add new line" /></li>
 								<li class="remove_row_img"><img src="<?php echo HOME_URL; ?>themes/images/remove.png" alt="remove this line" /> </li>
 								<li><input type="checkbox" name="line_id_cb" value="<?php echo htmlentities($om_so_line->item_description); ?>"></li>           
 								<li><?php echo form::hidden_field('om_so_header_id', $om_so_header->om_so_header_id); ?></li>
 							 </ul>
 							</td>
 							<td><?php form::text_field_wid2sr('om_so_line_id'); ?></td>
 							<!--<td><?php // form::text_field_wid2s('line_number');         ?></td>-->
 							<td><?php echo form::text_field('line_number', $$class_second->line_number, '8', '20', 1, 'Auto no', '', $readonly, 'lines_number'); ?></td>
 							<td><?php echo form::select_field_from_object('line_type', om_so_line::om_so_line_types(), 'option_line_id', 'option_line_code', $$class_second->line_type, 'line_type', $readonly); ?></td>
							...
							<td><?php echo form::select_field_from_object('uom', uom::find_all(), 'uom_id', 'uom', $$class_second->uom, 'uom');; ?></td>
 							...
 							<td class="add_detail_values"><img src="<?php echo HOME_URL; ?>themes/images/page_add_icon_16.png" class="add_detail_values_img" alt="add detail values" />
 							 <!--</td></tr>-->	
								<?php
								$om_so_line_id = $om_so_line->om_so_line_id;
								if (!empty($om_so_line_id)) {
								 $om_so_detail_object = om_so_detail::find_by_om_so_lineId($om_so_line_id);
								} else {
								 $om_so_detail_object = array();
								}
								if (count($om_so_detail_object) == 0) {
								 $om_so_detail = new om_so_detail();
								 $om_so_detail_object = array();
								 array_push($om_so_detail_object, $om_so_detail);
								}
								?>
 <!--						 <tr><td>-->
 									 ...
 									 <div id="tabsDetail-1-1" class="tabContent">
 										<table class="form form_detail_data_table detail">
 										 ...
 										 <tbody class="form_data_detail_tbody">
											 <?php
											 $detailCount = 0;
											 foreach ($om_so_detail_object as $om_so_detail) {
												$class_third = 'om_so_detail';
												$$class_third = &$om_so_detail;
												?>
												<tr class="om_so_detail<?php echo $count . '-' . $detailCount; ?><?php echo $detailCount != 0 ? ' new_object' : '' ?>">
												 <td>   
													<ul class="inline_action">
													 <li class="add_row_detail_img"><img  src="<?php echo HOME_URL; ?>themes/images/add.png"  alt="add new line" /></li>
													 <li class="remove_row_img"><img src="<?php echo HOME_URL; ?>themes/images/remove.png" alt="remove this line" /> </li>
													 <li><input type="checkbox" name="detail_id_cb" value="<?php echo htmlentities($om_so_detail->om_so_detail_id); ?>"></li>           
													 <li><?php echo form::hidden_field('om_so_line_id', $om_so_line->om_so_line_id); ?></li>
													 <li><?php echo form::hidden_field('om_so_header_id', $om_so_header->om_so_header_id); ?></li>

													</ul>
												 </td>
												 <td><?php form::text_field_wid3sr('om_so_detail_id'); ?></td>
