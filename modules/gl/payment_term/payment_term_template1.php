	 ...
	 <div id="content">
		<div id="structure">
		 <div id="payment_term_divId">
			...
			<div id ="form_header">
			 <form action=""  method="payment_termst" id="payment_term_header"  name="payment_term_header">
				<div id="tabsHeader">
				 <div class="large_shadow_box"><span class="heading">Payment Term Header </span>
					<ul class="column four_column">
					 <li>
						<label><a href="find_option.php" class="payment_termpup">
							<img src="<?php echo HOME_URL; ?>themes/images/serach.png"/></a>
						 Payment Term Id : </label>
						<?php echo form::text_field('payment_term_id', $$class->payment_term_id, '10', '', '', 'System number', 'headerId'); ?>
						<a name="show" href="" class="show payment_term_id">
			...
			<div id ="form_line" class="form_line"><span class="heading">PO Lines & Shipments </span>
			 <form action=""  method="payment_termst" id="payment_term_line"  name="payment_term_line">
				<div id="tabsLine">
				 <ul class="tabMain">
				 ...
				 <div class="tabContainer">
					...
					<div id="tabsLine-2" class="tabContent">
					 <table class="form_line_data_table">
						...
						<tbody class="form_data_line_tbody payment_term_discount_values">
						 <?php
						 $count = 0;
