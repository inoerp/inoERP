				 ...
				 <div id="tabsHeader">
					...
					<div class="tabContainer">
					 <div id="tabsHeader-1" class="tabContent">
						<div class="large_shadow_box"> 
						 <ul class="column five_column">
							<li>
							 <label><img id="gl_ledger_id_popup" class="showPointer popup" src="<?php echo HOME_URL; ?>themes/images/serach.png"/>
								Ledger Id : </label>
							 <?php echo form::number_field_drs('gl_ledger_id'); ?>
							 <a name="show" class="show gl_ledger_id">
							...
							<li><label>Char of Account : </label>
							 <?php echo form::select_field_from_object('coa_structure_id', coa::coa_structures(), 'option_header_id', 'option_type', $$class->coa_structure_id, 'coa_structure_id', $readonly); ?>
							</li>
							<li><label>Calendar : </label>
							 <?php echo form::select_field_from_object('calendar_option_line_code', gl_calendar::gl_calendar_names(), 'option_line_code', 'option_line_value', $$class->calendar_option_line_code, 'option_line_code', $readonly); ?>
							</li>
							<li><label>Currency : </label>
							 <?php echo form::select_field_from_object('currency_code', option_header::currencies(), 'option_line_code', 'option_line_code', $$class->currency_code, 'currency_code', $readonly); ?>
							</li>
					 ...
					 <div id="tabsHeader-2" class="tabContent">
						<div> 
						 <ul class="column five_column">
							<li><label>Retained Earnings : </label>
							 <?php form::account_field_m('retained_earnings_ac_id'); ?></li>
							<li><label>Suspense Account : </label>
							 <?php form::account_field_m('suspense_ac_id'); ?></li>
							<li><label>Currency Balancing : </label>
							 <?php form::account_field_m('currency_balancing_ac_id'); ?></li>
						 </ul>
						</div>
					 </div>
					</div>
