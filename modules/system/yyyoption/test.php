...
//
//$query =" SELECT * FROM option_detail ";
//$result_array = $db->result_array($query);
//
////$module_info = [
////	array("module"=>"option_header","primary_column"=>"option_id","key_field"=>"option_type"),
////	array("module"=>"option_line","primary_column"=>"option_line_id","key_field"=>"option_line_code"),
////];
////
//echo '<pre>';
...
//}
$query9= "ALTER TABLE option_detail
CHANGE value  option_detail_value varchar(256) NOT NULL";
//
//,
//CHANGE description_l  description varchar(256) NOT NULL,
//CHANGE efid_l  efid int(12),
//CHANGE status_l  status boolean,
//CHANGE rev_enabled_l  rev_enabled boolean,
//CHANGE rev_number_l  rev_number int(12),
//CHANGE created_by_l  created_by VARCHAR(256),
//CHANGE creation_date_l  creation_date  VARCHAR(256),
//CHANGE last_update_by_l  last_update_by  VARCHAR(256),
//CHANGE last_update_date_l   last_update_date  VARCHAR(256)";
//
...
echo '<br/> <b><u>Option Header</b></u>';
  $query = "SHOW COLUMNS FROM option_header ";
$result = $db->result_array($query);

foreach ($result as $option_header){
echo '<br/>Filed is : '. $option_header['Field'];
}
	
echo '<br/> <b><u>Option Line </b></u> ';
	$query1 = "SHOW COLUMNS FROM option_line ";
$result1 = $db->result_array($query1);

foreach ($result1 as $option_line){
echo '<br/>Filed is : '. $option_line['Field'];
}

echo '<br/> <b><u>Option Detail </b></u>';

$query2 = "SHOW COLUMNS FROM option_detail ";
$result2 = $db->result_array($query2);

foreach ($result2 as $option_detail){
echo '<br/>Filed is : '. $option_detail['Field'];
}
