...
if((!empty($_POST["option_id_l"])) && 
    (empty($_POST['submit_header'])) &&
    (empty($_POST['submit_line']))) {
  $option_id_l = $_POST["option_id_l"];
    $option = option_header::find_by_id($option_id_l);
  $option_line_object = option_line::find_by_option_id($option_id_l);
  if (count($option_line_object) == 0) {
    $option_id_l = 0;
  ...
  <div id="option">
    <div id="form_top">
      <ul class="form_top">
        ...
        <li><input type="submit" class="button" form="option_header" name="submit_header" id="submit_header" Value="Save Header"></li>
        <li><input type="submit" class="button" form="option_line" name="submit_line"  id="submit_line" Value="Save Line"></li>
        <li><input type="reset" class="button" name="reset" form="option_line" Value="Reset All"></li>
            ...
            <div class="three_column">
              <ul>
                <li>
                  ...
                  <a name="show" href="option.php?option_id_l=" class="show option_id_l">
                ...
                <li><label>Description : </label>
                  <input type="text" name="description" value="<?php echo htmlentities($option->description); ?>" maxlength="100" 
                         id="description">
                </li>
            ...
            <div class="three_column">
              <li class="control"> <span class="heading">Option Line </span>
                <ul class="showhide">
                  ...
                  <li><label>Description : </label>
                    <input type="text"  name="description_l[]" value="<?php echo htmlentities($option_line->description_l); ?>" maxlength="100" 
                           id="description_l">
                  </li>
                  <li><label>Extra Field : </label>
