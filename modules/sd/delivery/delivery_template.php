					 ...
					 <div class="large_shadow_box"> 
						<ul class="column five_column">
						 ...
						 <li><label>Inventory </label>
							<?php echo $f->select_field_from_object('shipping_org_id', org::find_all_inventory(), 'org_id', 'org', $$class->shipping_org_id, '', '', 1, $readonly1); ?>
						 </li>
						 <li><label>Number </label>
							<?php echo $f->text_field('delivery_number', $$class->delivery_number, '8', '', '', '', $readonly1); ?>
						 </li>
						 <li><label>Status </label>
							<?php $f = new inoform(); echo $f->select_field_from_array('status', sd_delivery_header::$status_a, $$class->status,'','',1,$readonly, $readonly1) ?>
						 </li>
						 <li><label>Date </label>
							<?php echo $f->date_fieldFromToday_mr('delivery_date', ino_date($$class->delivery_date), $readonly1); ?></li>
						</ul>
					 </div>
					</div>
