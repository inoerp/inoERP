	 ...
	 <div id="content">
		<div id="structure">
		 <div id="business_divId">
			<div id="form_top">
			 <?php
			 $current_page_path = "business.php";
			 if (empty($readonly)) {
			 ...
			 <form action=""  method="post" id="business"  name="business">
				<div class="large_shadow_box"><span class="heading">Business Org Header </span>
				 <ul class="column five_column"> 
					<li><label><a href="find_business.php" class="popup"> 
					...
					<li><label>Organization :</label>
					 <?php echo form::select_field_from_object('org_id', org::find_all_business(), 'org_id', 'org', $business->org_id, 'org', $readonly); ?>
					</li>
					<li><label>Extra Field : </label>
					 <?php echo form::extra_field($business->efid, '10', $readonly); ?>
					</li>
					 ...
					 <div class="three_column"> 
						<ul>
						 <li><label>Enterprise Name : </label> 
							<input type="text" name="name" value="<?php echo htmlentities($business->org); ?>" 
