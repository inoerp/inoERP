            ...
            <div class="large_shadow_box"> 
             <ul class="column four_column"> 
              <li> 
               ...
               <a name="show" href="form.php?class_name=hr_leave_type" class="show hr_leave_type_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
              </li>
