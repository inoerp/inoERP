            ...
            <div class="large_shadow_box"> 
             <ul class="column four_column"> 
              <li> 
               ...
               <a name="show" href="form.php?class_name=hr_job" class="show hr_job_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
              </li>
              ...
              <li><label>Position Type :</label>
               <?php echo $f->select_field_from_object('position_type', hr_job::job_position_type(), 'option_line_code', 'option_line_value', $$class->position_type, '', 'position_type', '', $readonly); ?>              </li>
              ...
              <li><label>Functional Area :</label>
               <?php echo $f->select_field_from_object('functional_area', hr_job::job_functional_area(), 'option_line_code', 'option_line_value', $$class->functional_area, '', 'functional_area', '', $readonly); ?>              </li>
             </ul>
            </div>
           </div>
