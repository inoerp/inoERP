					 ...
					 <div class="large_shadow_box"> 
						<ul class="column four_column">
						 <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="hr_position_hierarchy_header_id select_popup clickable">
							...
							<a name="show" href="form.php?class_name=hr_position_hierarchy_header_id" class="show hr_position_hierarchy_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
						 </li>
						 <li><label>Name : </label><?php $f->text_field_d('hierarchy_name'); ?></li>
						 <li><label>Starting Position : </label>
							<?php echo $f->select_field_from_object('starting_position_id', hr_position::find_all(), 'hr_position_id', 'position_name', $$class->starting_position_id, 'starting_position_id','',1,$readonly); ?>
						 </li>
