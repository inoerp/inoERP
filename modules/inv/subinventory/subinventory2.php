...
//  $subinventory->class = trim(mysql_prep($_POST['subinventory_class']));
//  echo '<br/> subinventory_class is : '. trim(mysql_prep($_POST['subinventory_class']));
  if (isset($_POST['primary'][$i])) {
   $subinventory->$value = 1;
  } else {
   $subinventory->$value = 0;
  }
...
//for new subinventory creation the subinventory id should be null 
  if (empty($subinventory->type) || empty($subinventory->subinventory) || empty($subinventory->org_id)
          || empty($subinventory->material_ac_id)) {
      ...
      <form action="subinventory.php" name="search_subinventory" method="GET" class="search_box subinventory_form" id="search_subinventory">
       <ul class="search_form">                   
        ...
        <li><label>Sub Inventory: </label>
         <input type="search" name="subinventory" id="subinventory" value="<?php
              ...
              <tbody class="subinventory_values">
               ...
               foreach ($result as $subinventory) {
                ...
                <tr id="subinventory_values<?php echo $count ?>">
                 ...
                 <td>    
                  <select name="locator_control[]" id="locator_control" class="locator_control"> 
                   <option value=""> </option>
                 ...
                 <td>
                  <input type="checkbox" name="allow_negative_balance[]" 
                         value="<?php echo (!empty($subinventory->allow_negative_balance)) ? "1" : ""; ?>"  id="allow_negative_balance"
                         <?php
                ...
                <tr id="subinventory_values<?php echo $count ?>">
                 ...
                 <td>
                  <input type="checkbox" name="rev_enabled[]" 
                         value="<?php echo (!empty($subinventory->rev_enabled)) ? "1" : ""; ?>"  id="rev_enabled"
                         <?php
