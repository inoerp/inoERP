						 ...
						 <tr class="inv_transaction_row0" id="tab1_1">
							<td>    
							 <ul class="inline_action">
								...
								<li><input type="checkbox" name="line_id_cb" value="<?php echo htmlentities($$class->inv_transaction_id); ?>"></li>           
							 </ul>
							</td>
							<td>
							...
							<td>
							 <input type="button"  class="popup itemId">
							 <?php form::text_field_wids('item_id'); ?>
							</td>
							<td>
							 <?php form::text_field_d('item_number'); ?>
							</td>
							<td>
							 <?php form::text_field_d('item_description'); ?>
							</td>
							<td>
							 <?php echo form::select_field_from_object('uom_id', uom::find_all(), 'uom_id', 'uom', $$class->uom_id, 'uom_id', $readonly); ?>
							</td>
							<td>
							 <?php form::text_field_wids('quantity'); ?>
							</td>
					 ...
					 <table class="form_table">
						...
						<tbody class="inv_transaction_values">
						 <tr class="inv_transaction_row0 transfer_info" id="tab2_1">
							<td>
							 <?php echo form::select_field_from_object('from_subinventory_id', subinventory::find_all_of_org_id($$class->org_id), 'subinventory_id', 'subinventory', $$class->from_subinventory_id, 'from_subinventory_id', $readonly, 'subinventory_id'); ?>
							</td>
							<td>
							 <?php echo form::select_field_from_object('from_locator_id', locator::find_all_of_subinventory($$class->from_subinventory_id), 'locator_id', 'locator', $$class->from_locator_id, 'from_locator_id', $readonly, 'subinventory_id'); ?>
							</td>
							<td>
							 <?php echo form::select_field_from_object('to_subinventory_id', subinventory::find_all_of_org_id($$class->org_id), 'subinventory_id', 'subinventory', $$class->to_subinventory_id, 'to_subinventory_id', $readonly, 'subinventory_id'); ?>
							</td>
							<td>
							 <?php echo form::select_field_from_object('to_locator_id', locator::find_all_of_subinventory($$class->to_subinventory_id), 'locator_id', 'locator', $$class->to_locator_id, 'to_locator_id', $readonly, 'subinventory_id'); ?>
							</td>
							<td>
