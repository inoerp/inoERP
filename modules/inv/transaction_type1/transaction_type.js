...
//  $('#item #form_box #item_id a.show').click(function() {
//    var itemId = $('#item_id').val();
////$(this).prop('href','item.php?item_id=' + moduleId);
//    $(this).attr('href', '../../org/item_org/find_item_org.php?item_id=' + itemId);
//  });
//  
    //Get the item_id on find button click
...
//add a new line on clickint add a new line
  ...
  $("#add_object").on("click",function() {
    $("tr#transaction_type_values0").clone().attr("id", "new_object" + objectCount).appendTo($("tbody#transaction_type_values"));
