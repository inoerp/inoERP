            ...
            <tr id="inv_transaction_rowtab1">
             ...
             <td>
              ...
              <input type="text"  name="item_number[]" id="item_number" size="15" value="<?php echo htmlentities($inv_transaction->item_number); ?>" 
                     maxlength="50" class="item_number" placeholder="Enter the item no"> 
             </td>
             <td>
              <input type="text"  name="uom_id[]" class="uom_id" size="10" value="<?php echo htmlentities($inv_transaction->uom_id); ?>" 
             ...
             <td>
              <select name="from_subinventory_id[]" class="from_subinventory_id" > 
               <option value="Select Org" disabled> </option>
              </select>
             </td>
             <td>
              <select name="from_locator_id[]" class="from_locator_id" > 
               <option value="Select Org" disabled> </option>
              </select>
             </td>
             <td>
              <select name="to_subinventory_id[]" class="to_subinventory_id" > 
               <option value="Select Org" disabled> </option>
              </select>
             </td>
             <td>
              <select name="to_locator_id[]" class="to_locator_id" > 
               <option value="Select Org" disabled> </option>
              </select>
             </td>
            </tr>
            ...
            <tr id="inv_transaction_rowtab3">
             <td>
              <input type="text" name="account[]" value="<?php echo htmlentities($inv_transaction->account); ?>" 
                     size="25" maxlength="150"  class="account"> 
             </td>
             <td>
              <input type="text" name="amount[]" value="<?php echo htmlentities($inv_transaction->amount); ?>" 
                     size="15" maxlength="10"  class="amount"> 
             </td>
             <td>
              <input type="text" name="costed_amount[]" value="<?php echo htmlentities($inv_transaction->costed_amount); ?>" 
                     size="15" maxlength="10"  class="costed_amount"> 
             </td>
             <td>
              <input type="checkbox" name="rev_enabled0" readonly class="rev_enabled"
                     value="1"
                     <?php
