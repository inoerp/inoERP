...
//get locator name
 ...
 function getLocator(subinventory_id, subinventory_type) {
  $('#loading').show();
  $.ajax({
...
//add new line by using + sign    
 $(".add_row_img").on("click", function() {
  ...
  $("#new_object" + objectCount + " #from_locator_id").val("");
  $("#new_object" + objectCount + " #item_number").autocomplete({source:'../item/item_search.php', minLength:2});
  from_subinventory_id=$("#new_object" + objectCount + " #from_subinventory_id").val();
  $("#new_object" + objectCount + " #from_subinventory_id").blur(function(){
   getLocator(from_subinventory_id, "from_subinventory")
  });
  to_subinventory_id=$("#new_object" + objectCount + " #to_subinventory_id").val();
  $("#new_object" + objectCount + " #to_subinventory_id").blur(function (){
   getLocator(to_subinventory_id, "to_subinventory_id")
  });
  objectCount++;
  remove_row();
 }
