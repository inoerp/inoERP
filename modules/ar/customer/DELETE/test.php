<?php
include_once('customer.inc');

//$item = new item;
//
//$customer_sites = customer_site::find_all();

//echo "<br/><br/><br/><br/><br/>current page is : ". thisPage_url();
//
//echo '<pre>';
//print_r($customer_sites);
...
//
//$query1="ALTER TABLE customer_bu
...
// ";
//
//$query1= "ALTER TABLE customer_site
// ADD pay_on varchar(50)  after payment_term_id,
// ADD debit_memo_onreturn_cb boolean  after pay_on,
// ADD fob varchar(50)  after debit_memo_onreturn_cb,
// ADD freight_terms int(12)  after fob,
// ADD transportation varchar(50)  after freight_terms,
// ADD country_of_origin varchar(50)  after transportation";
//////	
//////	$query1= "ALTER TABLE customer_bu
...
$query = "SHOW COLUMNS FROM ar_customer_bu ";
////
