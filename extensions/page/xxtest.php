...
<div id="all_blocks">
  <?php
  if (!empty($_GET['all_blocks']) && $_GET['all_blocks'] == 1) {
...
//          echo "<br/> show blok flag changed 3 ";
      ...
      if ($show_block_flag == 1) {
        $block_value = "<div class=\"block $reference_table block_$block_count\">";
        $block_value .= "<div class=\"block_title $reference_table \" > $title </div>";
        $block_value .= "<div class=\"block_content $reference_table \" > $content </div>";
        $block_value .="</div>";
      }
