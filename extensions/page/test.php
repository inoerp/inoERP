<?php require_once '../../include/basics/basics.inc' ?>
<?php
//include_once('wip_wo.inc');
global $db;
//$wip_header = wip_wo_header::find_all();
//echo '<pre>';
//print_r($wip_header);
//
//
...
//}
//
//$query1 = " CREATE TABLE wip_wo_resource_assignment(
//  wip_wo_resource_assignment_id int(12) NOT NULL AUTO_INCREMENT,
//  wip_wo_id int(12) NOT NULL,
...
//	PRIMARY KEY ( wip_wo_resource_assignment_id )
//	)";
//
//
//$result1 = $db->query($query1);

//$query11 = " CREATE TABLE wip_wo_rate_assignment(
//  wip_wo_rate_assignment_id int(12) NOT NULL AUTO_INCREMENT,
//  wip_wo_id int(12) NOT NULL,
...
//  last_update_by varchar(256),
//  last_update_date date,
//	PRIMARY KEY ( wip_wo_rate_assignment_id )
//	)";
//
//
//$result11 = $db->query($query11);

$query2= "ALTER TABLE page 
  ADD `show_in_frontpage_cb` boolean ";
...
//$query2= "ALTER TABLE wip_wo_routing_detail 
...
//$result2 = $db->query($query2);
//
//$query3= "ALTER TABLE wip_wo_header 
//  ADD `last_unit_completed_date` date AFTER first_unit_completed_date";
//
