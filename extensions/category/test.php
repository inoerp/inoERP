...
echo "Number of posts ". category::contentCount_by_categoryId_contentType(1);

$a=[];
$all_child_categoris = category::all_child_categories_withHirearchy(1,1, $a);
...
$all_child_categoris = category::all_child_categories('forum');
echo '--------------------------all childs with out hire are <pre>';
print_r($all_child_categoris);
