        ...
        <table id="category_list" class="normal">
         ...
         <tbody>
            ...
            <td>' . $major_category['description'] . '</td>
             <td><a href="form.php?class_name=category&category_id=' . $major_category['category_id'] . '">Update</a>&nbsp; &nbsp;' .
              ...
              <td>' . $child1['description'] . '</td>
               <td><a href="form.php?class_name=category&category_id=' . $child1['category_id'] . '">Update</a>&nbsp; &nbsp;' .
                ...
                <td><a href="form.php?class_name=category&category_id=' . $child2['category_id'] . '">Update</a> &nbsp; &nbsp;' .
                ...
                <td><a href="form.php?class_name=category&category_id=' . $child3['category_id'] . '">Update</a> &nbsp; &nbsp;' .
