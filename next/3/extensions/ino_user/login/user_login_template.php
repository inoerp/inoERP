         ...
         <div class="row">
          ...
          <div class="col-md-3"> 
           <fieldset>
            <ul>
             <li>Connect With</li>
             <li><a class="btn btn-default" role="button" href="<?php echo HOME_URL ?>extensions/user/user_login.php?provider=facebook"><i class="fa fa-facebook-square"></i> Facebook</a></li>
             <li><a class="btn btn-default" role="button" href="<?php echo HOME_URL ?>extensions/user/user_login.php?provider=google" ><i class="fa fa-google-plus-square"></i> Google</a></li>
            </ul>
