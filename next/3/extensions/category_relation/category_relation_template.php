  ...
  <table id="category_list" class="normal">
   ...
   <tbody>
    ...
    foreach ($all_categories as $major_category) {
     ...
     '<a href="form.php?class_name=category&&mode=9parent_id=' . $major_category['category_id'] . '">Add Child Category</a> 
                   </td></tr>';
     if (!empty($major_category['child'])) {
      ...
      foreach ($major_category['child'] as $child1) {
       ...
       '<a href="form.php?class_name=category&mode=9&parent_id=' . $child1['category_id'] . '">Add Child Category</a> 
                     </td></tr>';
       if (!empty($child1['child'])) {
        foreach ($child1['child'] as $child2) {
         ...
         '<a href="form.php?class_name=category&mode=9&parent_id=' . $child2['category_id'] . '">Add Child Category</a> 
                       </td></tr>';
         if (!empty($child2['child'])) {
          foreach ($child2['child'] as $child3) {
           ...
           '<a href="form.php?class_name=category&mode=9&parent_id=' . $child3['category_id'] . '">Add Child Category</a> 
                         </td></tr>';
          }
         }
        }
