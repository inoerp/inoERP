...
$(trClass).find('.ino-control-th.fa-minus-circle').removeClass('fa-minus-circle').addClass('fa-plus-circle');
...
$(trClass).find('.ino-control-th.fa-plus-circle').removeClass('fa-plus-circle').addClass('fa-minus-circle');
  ...
  $('table thead').each(function () {
   ...
   $(this).closest('table').find('tbody tr').each(function () {
    $(this).find('td').each(function (k, v) {
     if( k >0){
      $(this).before(thObject[k]);
     }else{
      $(thObject[k]).append(' <i class="ino-control-th fa fa-minus-circle clickable hide-form-row"></i>');
      $(this).before(thObject[k]);
     }
