...
// mandatoryCheck.mandatoryHeader();
 ...
 $('#am_wo_work_bench').off("change", '#transaction_type_id').on("change", '#transaction_type_id', function() {
...
//validation of entered quantity
 $('#am_wo_work_bench').off('focusout', '#from_operation_step').on('focusout', '#from_operation_step', function() {
 ...
 $("#am_wo_work_bench").off('focusout', '#move_quantity').on('focusout', '#move_quantity', function() {
...
//selecting wo header id data
 $('#am_wo_work_bench').off("click", '.am_wo_header_id.select_popup').on("click", '.am_wo_header_id.select_popup', function() {
...
$('#am_wo_work_bench').off('change', '#from_routing_sequence').on('change', '#from_routing_sequence' ,function(){
  if($(this).val()){
