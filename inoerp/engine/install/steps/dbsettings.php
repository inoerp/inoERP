...
<form action=""  method="post" id="dbsettings"  name="dbsettings" >
 <div >
  <ul class="list-group">
   ...
   <li class="list-group-item"><label class="label ino-label">Database Name</label><?php echo $f->text_field('db_name', '', '30', 'db_name', '', 1); ?></li>
   <li class="list-group-item"><label class="label ino-label">Database User Name</label><?php echo $f->text_field('db_user', '', '30', 'db_user', '', 1); ?></li>
