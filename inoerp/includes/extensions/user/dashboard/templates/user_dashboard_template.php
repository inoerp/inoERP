    ...
    <ul class="tabMain">
     ...
     foreach ($all_reports as $tab_c => $db_r) {
      ...
      if ($db_r->report_type == 'report') {
       echo '<li><a href="#tabsHeader-' . $tab_c . '" class="get-report-content" data-report_id="' . $db_r->report_id . '" >' . __($db_r->report_label) . '</a></li>';
      } else if ($db_r->report_type == 'view') {
       echo '<li><a href="#tabsHeader-' . $tab_c . '" class="get-view-content" data-view_id="' . $db_r->report_id . '" >' . __($db_r->report_label) . '</a></li>';
      } else {
       echo '<li><a href="#tabsHeader-' . $tab_c . '">' . __($db_r->report_label) . '</a></li>';
      }
     }
     ?>
    </ul>
