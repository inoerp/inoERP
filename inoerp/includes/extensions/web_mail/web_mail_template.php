...
<div id ="web_mail_divId">
 <form  method="post" id="web_mail"  name="web_mail">
  <span class="heading"><?php echo __('Web eMail') ?></span>
  <div id ="form_header">
   <div id="tabsHeader">
    <ul class="tabMain">
     <li><a href="#tabsHeader-1"><?php echo __('Message') ?></a></li>
     <li><a href="#tabsHeader-2"><?php echo __('Attachments') ?></a></li>
    </ul>
    <div class="tabContainer"> 
     <div id="tabsHeader-1" class="tabContent">
      <ul class="column header_field"> 
       <li><label><?php echo __('Email Id') ?></label><?php echo $f->text_field('email_id', $$class->email_id, '', 'email_id', 'email_id', 1, ''); ?></li>
       <li><label><?php echo __('CC Email') ?></label><?php echo $f->text_field('cc_email', $$class->cc_email, '', 'cc_email', 'cc_email', '', ''); ?></li>
       <li><label><?php echo __('BCC Email') ?></label><?php echo $f->text_field('bcc_email', $$class->bcc_email, '', 'bcc_email', 'bcc_email', '', ''); ?></li>
       <li><label><?php echo __('Subject') ?></label><?php echo $f->text_field('subject', $$class->subject, '', 'subject', 'subject', 1, ''); ?></li>
       <li><label><?php echo __('Copy Me') ?></label><?php echo $f->checkBox_field_d('send_me_copy_cb'); ?></li>
       <li><label><?php echo __('Create Note') ?></label><?php echo $f->checkBox_field_d('create_comment_cb'); ?></li>
