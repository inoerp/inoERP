<div id="form_all">
 <form action=""  method="post" id="mdm_price_list_header"  name="mdm_price_list_header"><span class="heading">Price List</span>
  <div id ="form_header">
   <div id="tabsHeader">
    <ul class="tabMain">
     ...
     <div id="tabsHeader-1" class="tabContent">
      <div class="large_shadow_box"> 
       <ul class="column header_field">
        <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="mdm_price_list_header_id select_popup clickable">
          Price List Id</label><?php echo form::number_field_drs('mdm_price_list_header_id'); ?>
         <a name="show" href="form.php?class_name=mdm_price_list_header&<?php echo "mode=$mode"; ?>" class="show document_id mdm_price_list_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
        </li>
        <li><label>Prices List</label><?php echo form::text_field_dm('price_list'); ?> </li>
        <li><label>Module*</label><?php echo form::select_field_from_array('module_name', mdm_price_list_header::$module_a, $$class->module_name, 'module_name', $readonly); ?></li>
