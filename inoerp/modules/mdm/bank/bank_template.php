 ...
 <form action=""  method="post" id="mdm_bank_site"  name="mdm_bank_site">
  <div class="line_before_tab"> 
   <ul class="column five_column inline_list"> 
    <li><?php $f->l_select_field_from_array('mdm_bank_site_id', mdm_bank_site::find_all_sitesOfHeader_array($$class->mdm_bank_header_id), $$class_second->mdm_bank_site_id, 'mdm_bank_site_id'); ?>
