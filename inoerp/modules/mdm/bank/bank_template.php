					 ...
					 <div class="large_shadow_box"> 
						<ul class="column four_column">
						 <li>
							...
							<a name="show" href="form.php?class_name=mdm_bank_header" class="show mdm_bank_header_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
						 </li>
						 <li><label>Bank Name : </label>
							<?php echo $f->text_field('bank_name', $$class->bank_name, '20', 'bank_name', 'select_bank_name', 1, $readonly); ?>
						 </li>
						 <li><label>Bank Number : </label><?php $f->text_field_d('bank_number'); ?></li>               
						 <li><label>Country : </label>
							<?php echo $f->select_field_from_object('country', mdm_tax_region::country(), 'option_line_code', 'option_line_value', $$class->country, 'country', '', 1, $readonly1); ?>
						 </li>
				...
				<div class="line_before_tab"> 
				 <ul class="column five_column inline_list"> 
					<li><label>Site Id : </label> 
					 ...
					 <a name="show" href="?mdm_bank_header_id=&mdm_bank_site_id=" class="show mdm_bank_site_id">
