<form  method="post" id="inv_serial_number"  name="inv_serial_number"><span class="heading"><?php echo __('Serial Number') ?></span>
 <div id ="form_header">
  <div id="tabsHeader">
   <ul class="tabMain">
 ...
 <div id ="form_line" class="form_line"><span class="heading"><?php echo __('Serial Number Details') ?> </span>
  <div id="tabsLine">
   <ul class="tabMain">
