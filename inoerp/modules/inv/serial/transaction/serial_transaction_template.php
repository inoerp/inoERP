    ...
    <div class="large_shadow_box"> 
     <ul class="column five_column">
      <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="inv_serial_transaction_header_id select_popup clickable">
       ...
       <a name="show" href="form.php?class_name=inv_serial_transaction_v&<?php echo "mode=$mode"; ?>" class="show document_id inv_serial_transaction_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
      </li>
