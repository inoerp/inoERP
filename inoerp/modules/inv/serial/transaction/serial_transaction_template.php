         ...
         <div id="tabsHeader-1" class="tabContent">
          <div class="large_shadow_box"> 
           <ul class="column five_column">
            <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="inv_serial_transaction_header_id select_popup clickable">
              Serial Number : </label> 
             <?php echo $f->hidden_field_withId('inv_serial_number_id_h', $inv_serial_number_id_h); ?>
             <?php echo $f->text_field('serial_number', $serial_number_h,'','serial_number') ?>
             <a name="show" class="show inv_serial_number_id clickable"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a></li>
