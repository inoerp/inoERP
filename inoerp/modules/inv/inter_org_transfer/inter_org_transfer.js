...
//get onhand
 $('#form_line').on('change', '.item_id_m, .from_subinventory_id, .from_locator_id', function() {
  var trClass = '.' + $(this).closest('tr').attr('class');
 ...
 $('#form_line').on('change', '.item_id_m, .to_subinventory_id, .to_locator_id', function() {
  var trClass = '.' + $(this).closest('tr').attr('class');
  var item_id_m = $('#form_line').find(trClass).find('.item_id_m').val();
 ...
 $('#form_line').on('change', '.transaction_quantity, .from_current_onhand, .to_current_onhand', function() {
 ...
 classContextMenu.docHedaderId = 'inv_interorg_transfer_header_id';
 classContextMenu.docLineId = 'inv_interorg_transfer_line_id';
 classContextMenu.btn1DivId = 'interorg_transfer_header';
 classContextMenu.btn2DivId = 'form_line';
 classContextMenu.trClass = 'interorg_transfer_line';
 ...
 classSave.json_url = 'form.php?class_name=interorg_transfer_header';
 classSave.form_header_id = 'inv_interorg_transfer_header';
 classSave.primary_column_id = 'inv_interorg_transfer_header_id';
