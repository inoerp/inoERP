   ...
   <div id="tabsHeader-1" class="tabContent">
    <div class="large_shadow_box"> 
     <ul class="column header_field">
      ...
      <a name="show" href="form.php?class_name=inv_lot_transaction_header_v&<?php echo "mode=$mode"; ?>" class="show document_id inv_lot_transaction_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
      </li>
