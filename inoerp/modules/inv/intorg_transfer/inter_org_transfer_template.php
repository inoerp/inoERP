<div id ="form_header"><span class="heading"><?php echo gettext('Inter-Org Transfer Header') ?></span>
 <div id="tabsHeader">
  ...
  <div class="tabContainer">
   <form method="post" id="inv_intorg_transfer_header"  name="inv_intorg_transfer_header">
    <div id="tabsHeader-1" class="tabContent">
     <ul class="column header_field">
      <li><?php $f->l_text_field_dr_withSearch('inv_intorg_transfer_header_id') ?>
       <a name="show" href="form.php?class_name=inv_intorg_transfer_header&<?php echo "mode=$mode"; ?>" class="show document_id inv_intorg_transfer_header_id"><i class="fa fa-refresh"></i></a> 
      </li>
      ...
      <li><?php echo $f->l_select_field_from_array('transaction_type_id', inv_intorg_transfer_header::$transaction_type_id_a, $$class->transaction_type_id, 'transaction_type_id', '', 1, $readonly1, $readonly1); ?>       </li>
     </ul>
    </div>
    ...
    <div id="tabsHeader-3" class="tabContent">
     <div id="comments">
      ...
      <div id ="display_comment_form">
       <?php
       $reference_table = 'inv_intorg_transfer_header';
       $reference_id = $$class->inv_intorg_transfer_header_id;
       ?>
      </div>
     </div>
    </div>
  ...
  <div id="tabsLine">
   ...
   <div class="tabContainer">
    <div id="tabsLine-1" class="tabContent">
     <table class="form_line_data_table">
      ...
      <tbody class="form_data_line_tbody">
       <?php
       $count = 0;
       foreach ($inv_intorg_transfer_line_object as $inv_intorg_transfer_line) {
        ?>    
        <tr class="inv_intorg_transfer_line<?php echo $count?>" data-line_status="<?php echo $$class_second->status ?>">
         <td>
          <?php
          echo ino_inline_action($$class_second->inv_intorg_transfer_line_id, array('from_org_id' => $$class->from_org_id,
           'to_org_id' => $$class->to_org_id, 'inv_intorg_transfer_header_id' => $$class->inv_intorg_transfer_header_id,
           'transaction_type_id' => $$class->transaction_type_id));
          ?>
         </td>
         <td><?php $f->seq_field_d($count) ?></td>
         <td><?php $f->text_field_d2sr('inv_intorg_transfer_line_id', 'lineId'); ?></td>
    ...
    <div id="tabsLine-3" class="tabContent">
     <?php
     $ls_trclass = 'inv_intorg_transfer_line';
     $line_object_ls = $inv_intorg_transfer_line_object;
     $each_line_ls = $inv_intorg_transfer_line;
     $line_class_name_sl = &$class_second;
     $ref_key_name = 'inv_intorg_transfer_line';
     $ref_key_val = 'inv_intorg_transfer_line_id';
...
<div id="js_data">
 <ul id="js_saving_data">
  <li class="headerClassName" data-headerClassName="inv_intorg_transfer_header" ></li>
  <li class="lineClassName" data-lineClassName="inv_intorg_transfer_line" ></li>
  <li class="savingOnlyHeader" data-savingOnlyHeader="false" ></li>
  <li class="primary_column_id" data-primary_column_id="inv_intorg_transfer_header_id" ></li>
  <li class="form_header_id" data-form_header_id="inv_intorg_transfer_header" ></li>
  <li class="line_key_field" data-line_key_field="item_id_m" ></li>
  <li class="single_line" data-single_line="false" ></li>
  <li class="form_line_id" data-form_line_id="inv_intorg_transfer_line" ></li>
 </ul>
 <ul id="js_contextMenu_data">
  <li class="docHedaderId" data-docHedaderId="inv_intorg_transfer_header_id" ></li>
  <li class="docLineId" data-docLineId="inv_intorg_transfer_line_id" ></li>
