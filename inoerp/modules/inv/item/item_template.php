		...
		<div id="tabsHeader-2" class="tabContent">
		 <div class="large_shadow_box"> 
			<ul class="column header_field">
			 ...
			 <li><?php
					 if (!empty($item->org_id)) {
						$f->l_select_field_from_object('assign_to_org', $org->findAll_inventory(), 'org_id', 'org', '', 'assign_to_org');
					 } else {
						$f->l_select_field_from_object('assign_to_org', $org->findAll_item_master(), 'org_id', 'org', '', 'assign_to_org', 'always_readonly', '', 1);
					 }
					 ?> 
			 </li>
			</ul>
