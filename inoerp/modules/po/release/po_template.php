           ...
           <div class="large_shadow_box"> 
            <ul class="column five_column">
             ...
             <li><label>PO Type(2) : </label>
              <?php echo $f->select_field_from_array('po_type', po_release::$po_type_a, $$class->po_type, 'po_type', '', 1); ?>
             </li>
             <li><label>PO Number : </label> <?php $f->text_field_d('po_number', 'primary_column2'); ?> </li>
             <li><label>Rel# : </label> 
              <?php echo $f->select_field_from_array('release_number', $bpa_release_number_a, $$class->release_number, 'release_number', 'primary_column3'); ?>
              <a name="show" href="form.php?class_name=po_release" class="show ref_po_header_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
             </li>
