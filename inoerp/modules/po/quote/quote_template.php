           ...
           <div class="large_shadow_box"> 
            <ul class="column five_column">
             <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="po_quote_header_id select_popup clickable">
               Header Id : </label>
              <?php $f->text_field_dsr('po_quote_header_id') ?>
              <a name="show" href="po.php?po_quote_header_id=" class="show po_quote_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
             </li>
             ...
             <li><label>Status : </label>                      
              <?php echo $f->select_field_from_array('quote_status', po_quote_header::$po_quote_status_a, $$class->quote_status, 'quote_status'); ?>
             </li>
             ...
             <li><label>Valid Till : </label>
              <?php echo $f->date_fieldAnyDay('valid_date', $$class->valid_date) ?>
             </li>
             <li><label>Currency : </label>
              <?php echo $f->select_field_from_object('currency', option_header::currencies(), 'option_line_code', 'option_line_code', $$class->currency, 'doc_currency', '', '', $readonly); ?>
             </li>
