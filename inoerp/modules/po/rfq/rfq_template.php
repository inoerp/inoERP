           ...
           <div class="large_shadow_box"> 
            <ul class="column five_column">
             <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="po_rfq_header_id select_popup clickable">
               Header Id : </label>
              <?php $f->text_field_dsr('po_rfq_header_id') ?>
              <a name="show" href="po.php?po_rfq_header_id=" class="show po_rfq_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
             </li>
             ...
             <li><label>RFQ Type(2) : </label>
              <?php echo $f->select_field_from_array('rfq_type', po_rfq_header::$po_rfq_type_a, $$class->rfq_type, 'rfq_type', '', 1); ?>
             </li>
             ...
             <li><label>Status : </label>                      
              <?php echo $f->select_field_from_array('rfq_status', po_rfq_header::$po_rfq_status_a, $$class->rfq_status, 'rfq_status'); ?>
             </li>
             <li><label>Buyer : </label><?php $f->text_field_d('buyer'); ?></li> 

             <li><label>Start Date : </label>
              <?php echo $f->date_fieldAnyDay('effective_start_date', $$class->effective_start_date) ?>
             </li>
             <li><label>End Date : </label>
              <?php echo $f->date_fieldAnyDay('effective_end_date', $$class->effective_end_date) ?>
             </li>
             <li><label>Due Date : </label>
              <?php echo $f->date_fieldAnyDay('due_date', $$class->due_date) ?>
             </li>
             <li><label>Doc Currency : </label>
              <?php echo $f->select_field_from_object('doc_currency', option_header::currencies(), 'option_line_code', 'option_line_code', $$class->doc_currency, 'doc_currency', '', '', $readonly); ?>
             </li>
             <li><label>Ledger Currency : </label>
              <?php echo $f->select_field_from_object('currency', option_header::currencies(), 'option_line_code', 'option_line_code', $$class->currency, 'currency', '', '', 1); ?>
             </li>
             <li><label>Payment Term : </label>
              <?php echo $f->select_field_from_object('payment_term_id', payment_term::find_all(), 'payment_term_id', 'payment_term', $$class->payment_term_id, 'payment_term_id', '', '', $readonly1); ?>
             </li>
            </ul>
           </div>
          </div>
