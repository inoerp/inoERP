      ...
      <tbody class="form_data_line_tbody">
       ...
       foreach ($prj_resource_list_line_object as $prj_resource_list_line) {
        ...
        <tr class="prj_resource_list_line<?php echo $count ?>">
         ...
         <td><?php echo $f->select_field_from_object('prj_expenditure_type_id', prj_expenditure_type::find_all(), 'prj_expenditure_type_id', 'expenditure_type', $$class_second->prj_expenditure_type_id, '' ,'resource_type_control'); ?>						 </td>
