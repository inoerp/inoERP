<div id ="form_all"><span class="heading"><?php echo __('Project Work Type') ?></span>
 <form method="post" id="prj_work_type"  name="prj_work_type">
  ...
  <div id ="form_line" class="form_line"><span class="heading"><?php echo __('Work Type Details') ?></span>
   <div id="tabsLine">
    <ul class="tabMain">
