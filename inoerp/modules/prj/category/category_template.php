...
-->
<div id ="form_header"><span class="heading"><?php  echo __('Project Category')  ?></span>
...
<div id="form_line" class="form_line"><span class="heading"><?php echo __('Category Values') ?></span>
