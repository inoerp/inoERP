  ...
  <div id="tabsHeader">
   ...
   <div class="tabContainer">
    ...
    <div id="tabsHeader-4" class="tabContent">
     <ul class="column header_field">
      <li><?php $f->l_text_field_d('labor_billing_type'); ?></li> 
      <li><?php $f->l_text_field_d('nlr_billing_type'); ?></li> 
      <li><?php $f->l_text_field_d('employee_schedule_id'); ?></li> 
      <li><?php $f->l_text_field_d('job_schedule_id'); ?></li> 
      <li><?php $f->l_text_field_d('nlr_schedule_id'); ?></li> 
      <li><?php $f->l_text_field_d('nlr_burden_schedule_id'); ?></li> 
      <li><?php $f->l_text_field_d('labor_burden_schedule_id'); ?></li> 
