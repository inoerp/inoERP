<div id ="form_all"><span class="heading"><?php echo __('Task status') ?></span>
 <form method="post" id="adm_task_status"  name="adm_task_status">
  ...
  <div id ="form_line" class="form_line"><span class="heading"><?php echo __('Task status Details') ?></span>
   <div id="tabsLine">
    <ul class="tabMain">
