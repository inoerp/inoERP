<div id="all_contents">
 ...
 <div id="content_right">
	<div id="content_right_left">
	 ...
	 <div id="content">
		<div id="structure">
		 <div id="ar_receipt_source_divId">
				...
				<div class="large_shadow_box tabContainer">
				 <ul class="column five_column"> 
					<li> <label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="ar_receipt_source_id select_popup clickable">
					 ...
					 <a name="show" href="form.php?class_name=ar_receipt_source" class="show ar_receipt_source_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
					</li>
