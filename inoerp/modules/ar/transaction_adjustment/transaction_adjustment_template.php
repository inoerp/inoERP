...
<div id ="form_header"><span class="heading"><?php echo gettext('Transaction Adjustments') ?></span>
 <div id="tabsHeader">
  <ul class="tabMain">
   ...
   <div id="tabsHeader-1" class="tabContent">
    <ul class="column header_field">
     <li><label><i class="wo_number select_popup clickable fa fa-search"></i>
       <?php echo gettext('Transaction Number') ?></label><?php
      $f->text_field_d('transaction_number');
      echo $f->hidden_field_withId('ar_transaction_header_id', $$class->ar_transaction_header_id);
      echo $f->hidden_field_withCLass('transaction_status', 'COMPLETED', 'popup_value');
      ?>
     </li>
...
<div id ="form_line" class="form_line"><span class="heading"><?php echo gettext('Operation Details') ?></span>
 <div id="tabsLine">
  ...
  <div class="tabContainer"> 
   <form action=""  method="post" id="ar_transaction_adjustment"  name="ar_transaction_adjustment">
     ...
     <table class="form_line_data_table">
      ...
      <tbody class="form_data_line_tbody wip_wo_routing_line_values" >
       ...
       foreach ($wip_wo_routing_detail_object as $wip_wo_routing_detail) {
        ...
        $$class_third = &$wip_wo_routing_detail;
        ?>
        <tr class="ar_transaction_adjustment<?php echo $detailCount ?>">
         <td>    
         ...
         <td><?php echo form::text_field_dsr('ar_transaction_adjustment_id'); ?></td>
        </tr>
        <?php
        $detailCount++;
       }
...
<div id="js_data">
 ...
 <ul id="js_contextMenu_data">
  <li class="docLineId" data-docLineId="ar_transaction_adjustment_id" ></li>
