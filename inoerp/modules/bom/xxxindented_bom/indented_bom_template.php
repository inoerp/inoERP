   ...
   <div id="tabsLine-1" class="tabContent">
    <table class="form_line_data_table">
     ...
     <tbody class="form_data_line_tbody">
      ...
      global $rowCount;
      $rowCount = 0;
      $bom_line_object_ai = new ArrayIterator($bom_line_object);
      $bom_line_object_ai->seek($position);
      while ($bom_line_object_ai->valid()) {
       $indented_bom_lines0 = $bom_line_object_ai->current();
       ...
       ?>
       <?php
       $bom_line_object_ai->next();
       if ($bom_line_object_ai->key() == $position + $per_page) {
        break;
       }
       $rowCount = $rowCount + 1;
      }
