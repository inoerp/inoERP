...
<div id ="form_header"><span class="heading"><?php echo gettext('Asset Source Lines') ?></span><?php $f = new inoform(); ?>
 <div id="tabsHeader">
  <ul class="tabMain">
...
<div id ="form_line" class="form_line"><span class="heading"> Source Line Details </span>
 <div id="tabsLine">
  <ul class="tabMain">
