<form action=""  method="post" id="fa_asset_class"  name="fa_asset_class"><span class="heading">Asset Class </span>
 <div id ="form_header">
  <div id="tabsHeader">
   <ul class="tabMain">
    ...
    <div id="tabsHeader-1" class="tabContent">
     <div class="large_shadow_box"> 
      <ul class="column header_field">
       <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="fa_asset_class_id select_popup clickable">
         Class Id</label><?php $f->text_field_dsr('fa_asset_class_id') ?>
        <a name="show" href="form.php?class_name=fa_asset_class&<?php echo "mode=$mode"; ?>" class="show document_id fa_asset_class_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
       </li>
       <li><label>BU Org</label><?php
        ...
        ?></li>
       <li><label>Class Name</label><?php echo $f->text_field_d('asset_class_name'); ?></li>
       <li><label>Description</label><?php echo $f->text_field('description', $$class->description, '20', 'description'); ?></li>
       <li><label>Type</label><?php echo $f->select_field_from_object('type', fa_asset_class::asset_class_type(), 'option_line_code', 'option_line_value', $$class->type, 'type', '', 1); ?></li>
    ...
    <div id="tabsHeader-4" class="tabContent">
     <div id="comments">
      ...
      <div id ="display_comment_form">
       <?php
       $reference_table = 'fa_asset_class';
       $reference_id = $$class->fa_asset_class_id;
       ?>
      </div>
      <div id="new_comment">
      </div>
 ...
 <div id ="form_line" class="form_line"><span class="heading"> Asset Class Details </span>
  <div id="tabsLine">
   <ul class="tabMain">
...
<div id="js_data">
 <ul id="js_saving_data">
  <li class="headerClassName" data-headerClassName="fa_asset_class" ></li>
  <li class="savingOnlyHeader" data-savingOnlyHeader="true" ></li>
  <li class="primary_column_id" data-primary_column_id="fa_asset_class_id" ></li>
  <li class="form_header_id" data-form_header_id="fa_asset_class" ></li>
 </ul>
 <ul id="js_contextMenu_data">
  <li class="docHedadeId" data-docHedadeId="fa_asset_class_id" ></li>
  <li class="btn1DivId" data-btn1DivId="fa_asset_class_id" ></li>
 </ul>
</div>