<div id='fp_forecast_header_divId'>
 <div id ="form_header"><span class="heading">Forecast Header </span>
      ...
      <div class="large_shadow_box"> 
       <ul class="column header_field">
        <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="forecast_header_id select_popup clickable">
          Forecast Id</label><?php $f->text_field_dr('fp_forecast_header_id'); ?>
         <a name="show" href="form.php?class_name=fp_forecast_header&<?php echo "mode=$mode"; ?>" class="show document_id fp_forecast_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
        </li>
        ...
        <li><label>Forecast Group</label><?php echo $f->select_field_from_object('forecast_group_id', fp_forecast_group::find_all(), 'fp_forecast_group_id', 'forecast_group', $$class->forecast_group_id, 'forecast_group_id', '', '', $readonly) ?>  </li>
        ...
        <li><label class="auto_complete">
          Customer Name</label><?php echo $f->text_field('customer_name', $$class->customer_name, '20', 'customer_name', 'select_customer_name', '', $readonly); ?></li>
