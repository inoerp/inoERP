    ...
    <div id="tabsHeader-1" class="tabContent">
     <div class="large_shadow_box"> 
      <ul class="column header_field">
       ...
       <a name="show" href="form.php?class_name=gl_budget&<?php echo "mode=$mode"; ?>" class="show action document_id gl_budget ino-left-30-n"><i class="fa fa-refresh"></i></a>
      </ul>
     </div>
    </div>
   </div>
...
//        pa($qa_cp_element_obj);
       foreach ($qa_cp_element_obj as $qa_cp_element) {
        ...
        $qa_cp_element_value = null;
         $field_value_obj = gl_budget::find_by_fieldName_referenceDetails($qa_cp_element->sys_element_name, $ref_key_name, $ref_key_value);
         if ($field_value_obj) {
