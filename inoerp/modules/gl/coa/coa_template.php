         ...
         <div class="large_shadow_box">
          <ul class="column four_column">
           <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="coa_id select_popup clickable">
            ...
            <a name="show" href="form.php?class_name=coa" class="show coa_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
           </li>
            ...
            <a name="show" class="show coa_structure_show"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
           </li>
