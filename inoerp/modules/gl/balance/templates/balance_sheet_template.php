...
function show_bs_rows(&$all_asset_parent_segments_ai, $account_code, $account_code_low_limit = '') {
 $count = $val_sum = 0;
 $ret_ar = [];
 $row_stmt = '';
...
?>
<h1 class="text-center">CONSOLIDATED BALANCE SHEETS</h1>
...
//  pa($all_asset_parent_segments_ai);
  $ret_a = show_bs_rows($all_asset_parent_segments_ai, '104000');
  ...
  <?php
  $ret_a = show_bs_rows($all_asset_parent_segments_ai, '104500');
  echo $ret_a['statement'];
  ...
  <?php
  $ret_a = show_bs_rows($all_asset_parent_segments_ai, '105300');
  echo $ret_a['statement'];
  ...
  <?php
  $ret_a = show_bs_rows($all_asset_parent_segments_ai, '199999');
  ...
  $all_asset_parent_segments_ai = new ArrayIterator($all_asset_parent_segments);
  $position = 0;
  $ret_a = show_bs_rows($all_asset_parent_segments_ai, '250000', '200000');
  echo $ret_a['statement'];
  ...
  $all_asset_parent_segments_ai = new ArrayIterator($all_asset_parent_segments);
  $position = 0;
  $ret_a = show_bs_rows($all_asset_parent_segments_ai, '399999', '300000');
  echo $ret_a['statement'];
