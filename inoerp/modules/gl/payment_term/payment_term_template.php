        ...
        <div class="large_shadow_box">
         <ul class="column four_column">
          <li>
           ...
           ?>
           <a href="form.php?class_name=payment_term" class="show payment_term_headerId"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
          </li>
      ...
      <div id ="form_line" class="form_line"><span class="heading">Schedule & Discount Lines </span>
       ...
       <div id="tabsLine">
        ...
        <div class="tabContainer">
         <div id ="form_line" class="form_line2">
