function setValFromSelectPage(cc_co_template_header_id, hr_employee_id, first_name, last_name, identification_id) {
 this.cc_co_template_header_id = cc_co_template_header_id;
...
setValFromSelectPage.prototype.setVal = function() {
 var cc_co_template_header_id = this.cc_co_template_header_id;
 var name = this.first_name + ' ' + this.last_name;
 var identification_id = this.identification_id;
 $("#cc_co_template_header_id").val(cc_co_template_header_id);
...
//mandatory and field sequence
 ...
 mandatoryCheck.header_id = 'cc_co_template_header_id';
...
// mandatoryCheck.mandatoryField();
 ...
 $(".cc_co_template_header_id.select_popup").click(function() {
  void window.open('select.php?class_name=cc_co_template_header', '_blank',
   'width=1000,height=800,TOOLBAR=no,MENUBAR=no,SCROLLBARS=yes,RESIZABLE=yes,LOCATION=no,DIRECTORIES=no,STATUS=no');
  return false;
 });

 //Get the bom_id on find button click
 $('#form_header a.show.cc_co_template_header_id').click(function() {
  var headerId = $('#cc_co_template_header_id').val();
  $(this).attr('href', modepath() + 'cc_co_template_header_id=' + headerId);
 });
 ...
 //add a new row
 onClick_add_new_row('tr.cc_co_template_line0', 'tbody.form_data_line_tbody', 2);
// $("#content").on("click", ".add_row_img", function() {
//  var addNewRow = new add_new_rowMain();
//  addNewRow.trClass = 'cc_co_template_line';
