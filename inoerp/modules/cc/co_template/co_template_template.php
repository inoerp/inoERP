           ...
           <div class="large_shadow_box"> 
            <ul class="column five_column">
             <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="cc_co_template_header_id select_popup clickable">
              ...
              <a name="show" href="form.php?class_name=cc_co_template_header_id" class="show cc_co_template_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
             </li>
