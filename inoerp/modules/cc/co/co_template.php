   ...
   <div id="content">
    <div id="structure">
     <div id="bom_divId">
              ...
              <div class="large_shadow_box"> 
               <ul class="column five_column">
                <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="cc_co_header_id select_popup clickable">
                 ...
                 <a name="show" href="form.php?class_name=cc_co_header_id" class="show cc_co_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
                </li>
                ...
                <li><label>Template :</label>
                 <?php echo $f->select_field_from_object('template_id', cc_co_template_header::find_all(), 'cc_co_template_header_id', 'template_name', $$class->template_id, 'template_id'); ?>
                </li>
                <li><label>Type : </label>
              ...
              <div class="large_shadow_box"> 
               <ul class="column five_column">
                ...
                <li><label>Process flow : </label>
                 <?php echo $f->select_field_from_object('process_flow_header_id', cc_co_header::find_all_cc_processFlow(), 'sys_process_flow_header_id', 'process_flow', $$class->process_flow_header_id, 'process_flow_header_id', '', 1, $readonly); ?></li>
      ...
      <div id="form_line2" class="form_line2"><span class="heading">Change Lines </span>
...
<div id="js_data">
 <ul id="js_saving_data">
  ...
  <li class="lineClassName" data-lineClassName="cc_co_process_flow_action" ></li>
  <li class="lineClassName2" data-lineClassName2="cc_co_line" ></li>
  ...
  <!--<li class="form_line_id" data-form_line_id="cc_co_line" ></li>-->
 </ul>
