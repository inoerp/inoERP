<div id ="form_header">
 <span class="heading"><?php echo __('Date Rules [For Maintenace Schedule]') ?></span>
 <div id="tabsHeader">
  <ul class="tabMain">
...
<div id ="form_line" class="form_line"><span class="heading"><?php echo __('Date Rules') ?></span>
 <div id="tabsLine">
  <ul class="tabMain">
     ...
     <table class="form_table">
      <thead> 
       <tr>
        ...
        <th><?php echo __('Base Interval Days') ?></th>
        <th><?php echo __('Cycle Interval Days') ?></th>
