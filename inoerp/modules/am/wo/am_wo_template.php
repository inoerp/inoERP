...
<div id="am_wo_divId">
 <div id="form_all">
  <div id ="form_header"><span class="heading"><?php
       echo __('Maintenance Work Order')
    ?></span>
     ...
     <div class="tabContainer">
      <div id="tabsHeader-1" class="tabContent">
       <ul class="column header_field">
        ...
        <li><label><?php echo __('Owning Department') ?></label><?php echo $f->select_field_from_object('department_id', bom_department::find_all(), 'bom_department_id', 'department', $$class->department_id, 'department_id', '', '', $readonly); ?></li>
