<div id ="form_all"><span class="heading"><?php echo __('Meter') ?></span>
...
<?php echo!(empty($comments)) ? $comments : ""; ?>
  ...
  <div id ="form_line" class="form_line"><span class="heading"><?php echo __('Meter Details') ?></span>
   <div id="tabsLine">
    <ul class="tabMain">
     <li><a href="#tabsLine-1"><?php echo __('Readings') ?></a></li>
