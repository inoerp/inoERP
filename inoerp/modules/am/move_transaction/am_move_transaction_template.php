...
<form  method="post" id="am_move_transaction"  name="am_move_transaction">
 <span class="heading"><?php echo __('Maintenance Move Transaction') ?></span>
 <div id ="form_header">
  <div id="tabsHeader">
   <ul class="tabMain">
 ...
 <div id ="form_line" class="form_line"><span class="heading"> Operation Details </span>
  <div id="tabsLine">
   <ul class="tabMain">
    ...
    <li><a href="#tabsLine-2"><?php echo __('Scrap') ?> </a></li>
    <li><a href="#tabsLine-3"><?php echo __('BOM (View Only)') ?> </a></li>
   </ul>
   <div class="tabContainer"> 
