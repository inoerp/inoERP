<form action=""  method="post" id="ec_control"  name="ec_control">
 <span class="heading"><?php echo __('eCommerce Controls') ?></span>
 <div id ="form_header">
  <div id="tabsHeader">
   <ul class="tabMain">
   ...
   <div class="tabContainer"> 
    <div id="tabsHeader-1" class="tabContent">
     ...
     <div class="small-left-padding"><label><?php echo __('Home Page') ?> </label>
 ...
 <div id ="form_line" class="form_line"><span class="heading">Other Details </span>
  <div id="tabsLine">
   <ul class="tabMain">
    <li><a href="#tabsLine-1"><?php echo __('Conformation eMail') ?></a></li>
   </ul>
   <div class="tabContainer"> 
    <div id="tabsLine-1" class="tabContent">
     <div class="first_rowset"> 
      <ul class="column header_field"> 
       <li><label><?php echo __('Send Conformation eMail') ?></label> <?php $f->checkBox_field_d('send_email_cb') ?></li>
       <li><?php $f->l_text_field_d('email_cc'); ?> </li>

      </ul>
      <ul class="inRow asperWidth"> 
       <li><label><?php echo __('eMail Template') ?></label> 
