...
-->
<div id ="form_header"><span class="heading"><?php echo __('Service Type') ?></span>
 <form action=""  method="post" id="hd_service_type_header"  name="hd_service_type_header">
  <div id="tabsHeader">
   <ul class="tabMain">
    <li><a href="#tabsHeader-1"><?php echo __('Basic Info') ?></a></li>
    <li><a href="#tabsHeader-2"><?php echo __('Repair Details') ?></a></li>
...
<div id="form_line" class="form_line"><span class="heading"><?php echo __('Service Type Lines') ?></span>
     ...
     <table class="form_line_data_table">
      <thead> 
       <tr>
        ...
        <th><?php echo __('Billing Type') ?></th>
