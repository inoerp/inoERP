      ...
      <div class="large_shadow_box"> 
       <ul class="column header_field"> 
        <li> 
         ...
         <a name="show" href="form.php?class_name=sd_opportunity&<?php echo "mode=$mode"; ?>" class="show document_id sd_opportunity_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
        </li>
