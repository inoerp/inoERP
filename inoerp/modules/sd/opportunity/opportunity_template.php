           ...
           <div id="tabsHeader-1" class="tabContent">
            <div class="large_shadow_box"> 
             <ul class="column header_field"> 
              <li> 
               <label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="sd_opportunity_id select_popup clickable">
                Id</label><?php $f->text_field_dsr('sd_opportunity_id') ?>
               <a name="show" href="form.php?class_name=sd_opportunity" class="show sd_opportunity_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
              </li>
              <li><label>Lead Id</label><?php $f->text_field_dr('sd_lead_id'); ?> 					</li>
              <li><label>Number</label><?php $f->text_field_dm('opportunity_number'); ?> 					</li>
              <li><label>Subject</label><?php $f->text_field_dm('subject'); ?> 					</li>
...
<div id="js_data">
 ...
 <ul id="js_contextMenu_data">
  <li class="docHedadeId" data-docHedadeId="sd_opportunity_id" ></li>
  <li class="btn1DivId" data-btn1DivId="sd_opportunity_id" ></li>
 </ul>
</div>
