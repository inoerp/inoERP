...
// });
 ...
 $('a.show.sd_quote_header_id').click(function () {
  var sd_quote_header_id = $('#sd_quote_header_id').val();
  $(this).attr('href', modepath() + 'sd_quote_header_id=' + sd_quote_header_id);
...
//add or show linw details
 addOrShow_lineDetails('tr.quote_line0');
...
//	add_new_row('tr.quote_line0', 'tbody.form_data_line_tbody', 3);
  var addNewRow = new add_new_rowMain();
  addNewRow.trClass = 'quote_line';
...
//remove po lines
 $("#remove_row").click(function () {
  $('input[name="quote_line_id_cb"]:checked').each(function () {
 ...
 classContextMenu.docHedaderId = 'sd_quote_header_id';
 classContextMenu.docLineId = 'sd_quote_line_id';
 classContextMenu.btn1DivId = 'quote_header';
 classContextMenu.btn2DivId = 'form_line';
 classContextMenu.trClass = 'quote_line';
 ...
 classSave.json_url = 'form.php?class_name=sd_quote_header';
 classSave.form_header_id = 'quote_header';
 classSave.primary_column_id = 'sd_quote_header_id';
 classSave.line_key_field = 'item_description';
 classSave.single_line = false;
 classSave.savingOnlyHeader = false;
 classSave.enable_select = true;
 classSave.headerClassName = 'sd_quote_header';
 classSave.lineClassName = 'sd_quote_line';
 classSave.saveMain();
