...
<div id="form_all">
    ...
    <div class="tabContainer"> 
     <div id="tabsHeader-1" class="tabContent">
       <ul class="column header_field">
        ...
        <li><?php $f->l_select_field_from_object('bu_org_id', org::find_all_business(), 'org_id', 'org', $$class->org_id, 'org_id', '', '', $readonly); ?>        </li>
 ...
 <div id ="form_line" class="form_line"><span class="heading"><?php echo gettext('Department Details') ?></span>
  <div id="tabsLine">
   ...
   <div class="tabContainer"> 
    <form action=""  method="post" id="lms_dept_res_assignment_line"  name="lms_dept_res_assignment_line">
       ...
       <tbody class="form_data_line_tbody lms_dept_res_assignment_values" >
        ...
        foreach ($lms_dept_res_assignment_object as $lms_dept_res_assignment) {
         ...
         <tr class="lms_dept_res_assignment<?php echo $count ?>">
          ...
          <td><?php $f->text_field_wid2r('lms_dept_res_assignment_id'); ?></td>
          <td><?php echo $f->select_field_from_object('cost_type_id', lms_cost_type::find_all(), 'lms_cost_type_id', 'cost_type', $$class_second->cost_type_id, '', 'cost_type_id medium'); ?></td>
