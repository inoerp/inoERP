      ...
      <div class="large_shadow_box"> 
       <ul class="column four_column">
        ...
        <li><label>Association Level : </label>
         ...
         <a name="show" href="form.php?class_name=bc_auto_trigger&<?php echo "mode=$mode"; ?>" class="show2 document_id bc_auto_trigger_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
        </li>
       </ul>
      </div>
     </div>
...
<div id="js_data">
 <ul id="js_saving_data">
  <li class="lineClassName" data-lineClassName="bc_auto_trigger" ></li>
  <li class="line_key_field" data-line_key_field="association_level" ></li>
  <li class="single_line" data-single_line="false" ></li>
  <li class="form_line_id" data-form_line_id="bc_auto_trigger" ></li>
 </ul>
 <ul id="js_contextMenu_data">
  <li class="docLineId" data-docLineId="bc_auto_trigger_id" ></li>
  <li class="btn2DivId" data-btn2DivId="form_line" ></li>
  <li class="trClass" data-trclass="bc_auto_trigger" ></li>
