            ...
            <div class="large_shadow_box"> 
             <ul class="column four_column"> 
              <li> 
               ...
               <a name="show" href="form.php?class_name=bc_label_request" class="show bc_label_request_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
              </li>
              ...
              <li><label>Transaction Type : </label>
               <?php echo $f->select_field_from_object('transaction_type_id', transaction_type::find_all(), 'transaction_type_id', 'transaction_type', $$class->transaction_type_id, 'transaction_type_id', '', '', 1); ?>
              </li>
              <li><label>Label Format :</label>
               <?php echo $f->select_field_from_object('bc_label_format_header_id', bc_label_format_header::find_all(), 'bc_label_format_header_id', 'format_name', $$class->bc_label_format_header_id, 'bc_label_format_header_id', '', '', 1); ?>              </li>
