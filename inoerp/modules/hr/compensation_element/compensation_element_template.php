<div id="all_contents">
 ...
 <div id="content_right">
  <div id="content_right_left">
   ...
   <div id="content">
    <div id="structure">
     <div id="hr_compensation_element_divId">
      <div id="form_top">
      </div>
            ...
            <div class="large_shadow_box"> 
             <ul class="column five_column"> 
              <li> 
               ...
               <a name="show" href="form.php?class_name=hr_compensation_element" class="show hr_compensation_element_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
              </li>
              <li><label>Element Name :</label><?php $f->text_field_d('element_name'); ?> 					</li>
              <li><label>Type :</label>
               <?php echo $f->select_field_from_object('element_type', hr_compensation_element::compensation_element_type(), 'option_line_code', 'option_line_value', $$class->element_type, 'element_type', '', 1, $readonly1); ?> 					</li>
              <li><label>Class :</label>
               <?php echo $f->select_field_from_object('classification', hr_compensation_element::compensation_element_class(), 'option_line_code', 'option_line_value', $$class->classification, 'classification', '', '', $readonly); ?> 					</li>
              <li><label>Category :</label>
               <?php echo $f->select_field_from_object('category', hr_compensation_element::compensation_element_category(), 'option_line_code', 'option_line_value', $$class->category, 'category', '', 1, $readonly1); ?> 					</li>
