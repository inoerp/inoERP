     ...
     <div class="large_shadow_box"> 
      <ul class="column header_field">
       <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="hr_team_header_id select_popup clickable">
        ...
        <a name="show" href="form.php?class_name=hr_team_header&<?php echo "mode=$mode"; ?>" class="show document_id hr_team_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
       </li>
