           ...
           <div class="large_shadow_box"> 
            <ul class="column five_column">
             <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="hr_leave_entitlement_header_id select_popup clickable">
              ...
              <a name="show" href="form.php?class_name=hr_leave_entitlement_header_id" class="show hr_leave_entitlement_header_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
             </li>
