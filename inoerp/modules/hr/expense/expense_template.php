     ...
     <div class="large_shadow_box"> 
      <ul class="column header_field">
       ...
       <li><?php
        ...
        echo $f->hidden_field_withCLass('hr_employee_id', $$class->hr_employee_id,'hr_employee_id');
 ...
 <form method="post" id="hr_expense_line"  name="hr_expense_line">
  <div id="tabsLine">
   <ul class="tabMain">
    ...
    <li><a href="#tabsLine-2"><?php echo gettext('Per Diem') ?></a></li>
    <li><a href="#tabsLine-3"><?php echo gettext('Mileage') ?></a></li>
    <li><a href="#tabsLine-4"><?php echo gettext('Credit Card') ?></a></li>
   </ul>
   <div class="tabContainer">
      ...
      <tbody class="form_data_line_tbody">
       ...
       foreach ($hr_expense_line_object as $hr_expense_line) {
        ...
        <tr class="hr_expense_line<?php echo $count ?>">
         ...
         <td><?php $f->text_field_wid2s('line_number'); ?></td>
    ...
    <div id="tabsLine-2" class="tabContent">
     <table class="form_line_data_table">
      ...
      <tbody class="form_data_line_tbody form_data_line_tbody2">
       <?php
       foreach ($hr_expense_line_object as $hr_expense_line) {
        ?>         
        <tr class="hr_expense_line<?php echo $count ?>">
    ...
    <div id="tabsLine-3" class="tabContent">
     <table class="form_line_data_table">
      ...
      <tbody class="form_data_line_tbody form_data_line_tbody3">
       <?php
       foreach ($hr_expense_line_object as $hr_expense_line) {
        ?>         
        <tr class="hr_expense_line<?php echo $count ?>">
    ...
    <div id="tabsLine-4" class="tabContent">
     <table class="form_line_data_table">
      ...
      <tbody class="form_data_line_tbody form_data_line_tbody4">
       <?php
       foreach ($hr_expense_line_object as $hr_expense_line) {
        ?>         
        <tr class="hr_expense_line<?php echo $count ?>">
