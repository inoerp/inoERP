...
<div id ="form_header">
 <form  method="post" id="hr_element_history_header"  name="hr_element_history_header">
  <span class="heading"><?php echo __('Compensation History') ?></span>
  <div id="tabsHeader">
   <ul class="tabMain">
    ...
    <div id="tabsHeader-1" class="tabContent">
     <div class="large_shadow_box"> 
      <ul class="column header_field">
       ...
       <li><label><?php echo __('Employee Name') ?></label><?php $f->text_field_dr('employee_name'); ?>
...
<div id="form_line" class="form_line"><span class="heading"><?php echo __('Element History Lines') ?></span>
