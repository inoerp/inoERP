 ...
 <div id="form_headerDiv">
  <form action=""  method="post" id="hr_payslip_header"  name="hr_payslip_header"><span class="heading">Employee Pay Slip  </span>
   <table class="document_table">
    <tr> 
     <td><label> Pay Slip Id # : </label><?php $f->text_field_dr('hr_payslip_header_id'); ?> </td>
     <td><label> Employee Name : </label><?php $f->text_field_d('employee_name'); ?>
    ...
    <tr>
     <td><label> Period Name  : </label>
      ...
      <a name="show" href="form.php?class_name=hr_payslip_user" class="show period_name_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> </td>
