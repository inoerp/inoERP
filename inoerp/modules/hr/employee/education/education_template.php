  ...
  <form action=""  method="post" id="hr_employee_education_line"  name="employee_education_line"><span class="heading">Employee Education </span>
   <div id="tabsLine">
    <div id="form_serach_header">
     ...
     <a name="show" href="form.php?class_name=hr_employee_education&<?php echo "mode=$mode"; ?>" class="show document_id employee_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
    </div>
