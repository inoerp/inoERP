...
// mandatoryCheck.mandatoryField();
 ...
 $('#form_header a.show.hr_element_entry_header_id').click(function() {
  var headerId = $('#hr_element_entry_header_id').val();
  $(this).attr('href', modepath() + 'hr_element_entry_header_id=' + headerId);
 });
 ...
 //add a new row
// onClick_add_new_row('tr.hr_element_entry_line0', 'tbody.form_data_line_tbody', 3);
 $("#content").on("click", ".add_row_img", function() {
  var addNewRow = new add_new_rowMain();
  addNewRow.trClass = 'hr_element_entry_line';
