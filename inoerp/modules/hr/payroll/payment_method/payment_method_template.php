     ...
     <div id="tabsHeader-1" class="tabContent">
      <div class="large_shadow_box"> 
       <ul class="column four_column"> 
        ...
        <a name="show" href="form.php?class_name=hr_payroll_payment_method&<?php echo "mode=$mode"; ?>" class="show document_id hr_payroll_payment_method_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
        </li>
