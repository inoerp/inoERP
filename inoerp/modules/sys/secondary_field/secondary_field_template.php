      ...
      <div class="large_shadow_box"> 
       <ul class="column four_column"> 
        <li> 
         ...
         <a name="show" href="form.php?class_name=sys_secondary_field&<?php echo "mode=$mode"; ?>" class="show document_id sys_secondary_field_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
        </li> 
