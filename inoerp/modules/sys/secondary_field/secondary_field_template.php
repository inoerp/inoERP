<div id="all_contents">
 ...
 <div id="content_right">
  <div id="content_right_left">
   ...
   <div id="content">
    <div id="structure">
     <div id="sys_secondary_field_divId">
      <div id="form_top">
      </div>
      ...
      <div id ="form_header">
       <form action=""  method="post" id="sys_secondary_field_form"  name="sys_secondary_field_form"><span class="heading">Secondary Fields</span>
        <div id ="form_header">
         <div id="tabsHeader">
          <ul class="tabMain">
           ...
           <div id="tabsHeader-1" class="tabContent">
            <div class="large_shadow_box"> 
             <ul class="column four_column"> 
              <li> 
               <label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="sys_secondary_field_id select_popup clickable">
                Field Id : </label> 
               <?php $f->text_field_dr('sys_secondary_field_id') ?>
               <a name="show" href="form.php?class_name=sys_secondary_field" class="show sys_secondary_field_id">	<img src="<?php echo HOME_URL; ?>themes/images/refresh.png" class="clickable"></a> 
              </li> 
              ...
              <li><label>Field Type :</label>
               <?php echo $f->select_field_from_object('field_type', sys_secondary_field::sys_secondary_field_type(), 'option_line_code', 'option_line_value', $$class->field_type, 'field_type', '', 1, $readonly1); ?>
              </li>
              ...
              <li><label>Display Type :</label>
               <?php echo $f->select_field_from_array('display_type', sys_secondary_field::$display_type_a, $$class->display_type); ?>
              </li>
