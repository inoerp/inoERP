<div id="view_divId">
 <div id ="form_header"> <span class="heading"> Form Personalization  </span>
  <form action=""  method="post" id="sys_form_personalization_header"  name="sys_form_personalization_header">
   ...
   <div id="form_line" class="form_line"><span class="heading">Form Personalization Details </span>
    <div id="tabsDetailD">
     <ul class="tabMain">
