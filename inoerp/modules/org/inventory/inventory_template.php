    ...
    <div id="tabsHeader-1" class="tabContent">
     <div class="large_shadow_box"> 
      <ul class="column header_field"> 
       <li><label><img src="<?php echo HOME_URL; ?>themes/images/serach.png" class="inventory_id select_popup clickable">
         Inventory Id</label><?php $f->text_field_ds('inventory_id') ?>
        <a name="show" href="form.php?class_name=inventory&<?php echo "mode=$mode"; ?>" class="show document_id inventory_id"><img src="<?php echo HOME_URL; ?>themes/images/refresh.png"/></a> 
       </li> 
       <li><label>Organization</label><?php echo form::select_field_from_object('org_id', org::find_all_inventory(), 'org_id', 'org', $inventory->org_id, 'org_id', $readonly); ?> </li>
       <li><label>Status</label><?php echo form::status_field($inventory->status, $readonly); ?></li>
       <li><label>Revision</label><?php echo form::revision_enabled_field($inventory->rev_enabled, $readonly); ?></li>
       <li><label>Revision No</label><?php echo form::text_field('rev_number', $inventory->rev_number, '10', '', '', '', '', $readonly); ?>   </li>
      </ul>
     </div>
    </div>
     ...
     <div id="tabsLine-1" class="tabContent">
      <div> 
       <ul class="column four_column"> 
        ...
        <li><label>POS Price List : </label>
         <?php echo $f->select_field_from_object('pos_price_list_header_id', mdm_price_list_header::find_all(), 'mdm_price_list_header_id' , 'price_list' ,$$class->pos_price_list_header_id, 'pos_price_list_header_id'); ?>
        </li> 
       </ul> 
      </div> 
