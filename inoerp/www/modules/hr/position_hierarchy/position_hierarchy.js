function setValFromSelectPage(hr_position_hierarchy_header_id) {
 this.hr_position_hierarchy_header_id = hr_position_hierarchy_header_id;
}

setValFromSelectPage.prototype.setVal = function() {
 var hr_position_hierarchy_header_id = this.hr_position_hierarchy_header_id;
 $("#hr_position_hierarchy_header_id").val(hr_position_hierarchy_header_id);
};
...
$(document).ready(function() {
 ...
 $(".hr_position_hierarchy_header_id.select_popup").click(function() {
	void window.open('select.php?class_name=hr_position_hierarchy_header', '_blank',
