						 ...
						 <tbody class="form_data_line_tbody engine_values" >
							...
							foreach ($all_data as $modules) {
							 ...
							 foreach ($modules as $submodules) {
								...
								$enabled_cb_v = ($this_engine_i != false) ? $this_engine_i->enabled_cb : '';
								$engine_id_v = ($this_engine_i != false) ? $this_engine_i->engine_id : '';
								?>         
								<tr class="engine_line<?php echo $count ?>">
								 ...
								 <td><?php echo $f->text_field_ap(['name' => 'description', 'value' => $submodules['description'], 'size' => '60', 'readonly' => 1]) ?></td>
								 <td><?php echo $f->text_field_ap(['name' => 'db_version', 'value' => $submodules['db_version'], 'size' => '6', 'readonly' => 1]) ?></td>
								 <td><?php echo $f->text_field_ap(['name' => 'db_version', 'value' => $submodules['db_version'], 'size' => '6', 'readonly' => 1]) ?></td>
								 <td><?php echo $f->checkBox_field('installed_cb', '', '', '', 1); ?></td>
