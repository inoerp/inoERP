<div class="container target">
 <div class="row">
  <div class="col-sm-3">
   ...
   <a class="getAjaxForm btn btn-info send_message " role="button" href="form.php?class_name=extn_emessage_header&user_id=<?php echo $user_ai->ino_user_id ?>">Internal Message  <i class="fa fa-wechat clickable"></i></a>
