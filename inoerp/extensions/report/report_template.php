<div id="extn_report_divId">
 <div id ="form_header"> <span class="heading"><?php echo gettext('Custom Report Builder'); ?>  </span>
  <form method="post" id="extn_report_header"  name="extn_report_header">
   <div id="tabsHeader">
    <ul class="tabMain">
     <li><a href="#tabsHeader-1"><?php echo getttext('Basic Info')?></a></li>
     <li><a href="#tabsHeader-2"><?php echo getttext('Path')?></a></li>
     <li><a href="#tabsHeader-3"><?php echo getttext('Extra Fields')?></a></li>
     <li><a href="#tabsHeader-4"><?php echo getttext('Display Options')?></a></li>
    </ul>
    <div class="tabContainer">
     <div id="tabsHeader-1" class="tabContent">
      <ul class="column header_field"> 
       ...
       <li><label><?php echo getttext('Report Name')?></label> <?php $f->text_field_dm('report_name'); ?> </li>
       <li><label><?php echo getttext('Description')?></label> <?php $f->text_field_dl('description'); ?> </li>
     ...
     <div id="tabsHeader-2" class="tabContent">
      <div> 
       <ul class="column header_field">
        <li><label><?php echo getttext('Path Id')?></label> <?php echo $f->text_field_dr('path_id'); ?></li>
        <li><label><?php echo getttext('Path Value')?></label><?php echo $f->text_field_dl('path'); ?></li>
        <li><label><?php echo getttext('View Report')?></label><a target='_blank' href="<?php echo HOME_URL . $$class->path; ?>"> <?php echo getttext('Online')?> </a></li>
        <li><label><?php echo getttext('Update Parent')?></label> <?php echo $f->checkBox_field('update_parent_id_cb', $$class->update_parent_id_cb); ?></li>
        <li><label><?php echo getttext('Add to menu with parent')?></label>
     ...
     <div id="tabsHeader-3" class="tabContent">
      <div> 
       <ul class="column four_column">
        <li><label><?php echo getttext('Custom Div Class')?></label> <?php echo $f->text_field_dl('custom_div_class'); ?></li>
        <li><label><?php echo getttext('Header Text')?></label><?php echo $f->text_area('header_text', $$class->header_text); ?></li>
        <li><label><?php echo getttext('Footer Text')?></label> <?php echo $f->text_area('footer_text', $$class->footer_text); ?></li>
        <li><label><?php echo getttext('Remove Default Header')?></label> <?php echo $f->checkBox_field('remove_default_header_cb', $$class->remove_default_header_cb); ?></li>
       </ul>
      </div>
     </div>
     <div id="tabsHeader-4" class="tabContent">
      <div> 
       <ul class="column header_field">
        <li><label><?php echo getttext('Columns in Grid')?></label> <?php echo $f->number_field('no_of_grid_columns', $$class->no_of_grid_columns, '', 'no_of_grid_columns', 'large'); ?></li>
        <li><label><?php echo getttext('Default Per Page')?></label> <?php echo $f->number_field('default_per_page', $$class->default_per_page, '', 'default_per_page', 'large'); ?></li>
        <li><label><?php echo getttext('List Type')?></label>
         <?php echo $f->select_field_from_array('list_type', dbObject::$list_type_a, $$class->list_type); ?></li>
        <li><label><?php echo getttext('Create/Update Block')?></label><?php echo $f->checkBox_field('create_block_cb', ''); ?></li>
        <li><label><?php echo getttext('Show only graph in block')?></label><?php echo $f->checkBox_field('show_graph_only_cb', $$class->show_graph_only_cb); ?></li>
        <li><label><?php echo getttext('Dont show graph')?></label><?php echo $f->checkBox_field('dont_show_graph_cb', $$class->dont_show_graph_cb); ?></li>
        <li><label><?php echo getttext('View Block')?></label>
         <?php
   ...
   <div id="form_line" class="form_line"><span class="heading">Report Details </span>
    <div id="tabsLine">
     <ul class="tabMain">
      <li><a href="#tabsLine-1"><?php echo getttext('SQL Query')?></a></li>
      <li><a href="#tabsLine-2"><?php echo getttext('Live Display')?></a></li>
      <li><a href="#tabsLine-3"><?php echo getttext('Graph')?></a></li>
     </ul>
     <div class="tabContainer">
      ...
      <div id="tabsLine-2" class="tabContent">
       <div id="basic_settings"><span class="heading"><input type="button" value="Display Result" class="button display_result" id="display_report_result"></span>
        <div id="live_display"><label><?php echo getttext('Live Display')?></label>
       ...
       <div id="basic_settings">
        ...
        <div> 
         <ul class="column header_field form_header_l">
          ...
          <li><label><?php echo getttext('Value Field')?></label>
           <?php
           if (!empty($column_list)) {
          ...
          <li><label><?php echo getttext('Legend')?></label>
           <?php
           if (!empty($column_list)) {
           ...
           ?></li>
          <li><label><?php echo getttext('Legend 2')?></label>
           <?php
           if (!empty($column_list)) {
